    ...
    if request.method == "POST":
        try:
            ...
            current_data = requests.get(
                f"https://api.openweathermap.org/data/2.5/weather?q={city}&appid=2be54f58c660924bb608d83b3a204801&units=metric")
    ...
    if request.method == "POST":
        try:
            ...
            parameters = {
                "lat": LAT,
                "lon": LON,
                "appid": "2be54f58c660924bb608d83b3a204801",
            }
        except KeyError:
            return render_template('404_error.html')
        else:
            ...
            graph_temp = [
                ("After 1 Hour", temperature_1),
                ("After 2 Hours", temperature_2),
                ("After 3 Hours", temperature_3),
                ("After 4 Hours", temperature_4),
                ("After 5 Hours", temperature_5),
            ]
            ...
            graph_hum = [
                ("After 1 Hour", humidity_1),
                ("After 2 Hours", humidity_2),
                ("After 3 Hours", humidity_3),
                ("After 4 Hours", humidity_4),
                ("After 5 Hours", humidity_5),
            ]
